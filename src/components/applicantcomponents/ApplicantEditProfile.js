...
function ApplicantEditProfile() {
  ...
  const validateForm = (fielname) => {
    ...
    if (fielname === "" || fielname === "email") {
      ...
      newErrors.applicant.email = emailRegex.test(applicant.email)
        ? ""
    ...
    if (fielname === "" || fielname === "name") {
      ...
      if (!/^[a-zA-Z\s]+$/.test(applicant.name)) {
        newErrors.applicant.name =
          "Please enter a valid full name and should not have any numbers and special char.";
      }
      if (applicant.name.length < 3) {
        newErrors.applicant.name =
          "Full name should be at least three characters long.";
      }
    }
    if (fielname === "" || fielname === "mobilenumber") {
      ...
      if (!/^\d+$/.test(applicant.mobilenumber)) {
        newErrors.applicant.mobilenumber =
      ...
      if (!["6", "7", "8", "9"].includes(firstDigit)) {
        newErrors.applicant.mobilenumber =
          "Mobile number should begin with 6, 7, 8, or 9.";
      }
    }
      ...
      if (basicDetails && (fielname === "" || fielname === "dateOfBirth")) {
        if (!/^\d{4}-\d{2}-\d{2}$/.test(basicDetails.dateOfBirth)) {
          ...
          if (
            selectedDate >
            new Date(
              currentDate.getFullYear() - maxAllowedAge,
              currentDate.getMonth(),
              currentDate.getDate(),
            )
          ) {
            newErrors.basicDetails.dateOfBirth =
              "The Date of Birth should be at least 18 years ago.";
          }
        }
      }
    }
    ...
    if (fielname === "" || fielname === "pincode") {
      if (!basicDetails.pincode) {
        ...
        newErrors.basicDetails.pincode =
          "Pincode should be 6 digits and contain only numbers";
      }
    }
    ...
    if (fielname === "" || fielname === "xschoolName") {
      if (!xClassDetails.xschoolName) {
        ...
        if (!/^[a-zA-Z\s]+$/.test(xClassDetails.xschoolName)) {
          newErrors.xClassDetails.xschoolName =
            "School name should not be number";
        }
      }
    }
    ...
    if (fielname === "" || fielname === "xpercentage") {
      if (!xClassDetails.xpercentage) {
        ...
        if (
          !validPercentageRegex.test(percentageValue) ||
          parseFloat(percentageValue) < 0 ||
          parseFloat(percentageValue) > 100
        ) {
          newErrors.xClassDetails.xpercentage =
            "Enter a valid percentage between 0 and 100 (only digits and period(.) are allowed)";
        }
      }
    }
    ...
    if (fielname === "" || fielname === "xPincode") {
      if (!xClassDetails.xPincode) {
        ...
        newErrors.xClassDetails.xPincode =
          "Pincode should be 6 digits and contain only numbers";
      }
    }
    if (fielname === "" || fielname === "xyearOfPassing") {
      if (!xClassDetails.xyearOfPassing) {
        ...
        if (!/^\d{4}$/.test(xClassDetails.xyearOfPassing)) {
          newErrors.xClassDetails.xyearOfPassing =
            "Year of passing should be a 4-digit number";
        } else {
          if (!/^\d+$/.test(xClassDetails.xyearOfPassing)) {
            newErrors.xClassDetails.xyearOfPassing =
              "Year of passing should contain only digits";
          }
        }
      }
    }
    ...
    if (fielname === "" || fielname === "icollegeName") {
      if (!intermediateDetails.icollegeName) {
        ...
        if (!/^[a-zA-Z\s]+$/.test(intermediateDetails.icollegeName)) {
          newErrors.intermediateDetails.icollegeName =
            "College name should not be number";
        }
      }
    }
    if (fielname === "" || fielname === "iboard") {
      if (!intermediateDetails.iboard) {
        ...
        if (!/^[a-zA-Z\s]+$/.test(intermediateDetails.iboard)) {
          newErrors.intermediateDetails.iboard =
            "Board name should not be number only";
        }
      }
    }
    if (fielname === "" || fielname === "iprogram") {
      if (!intermediateDetails.iprogram) {
        ...
        if (!/^[a-zA-Z\s]+$/.test(intermediateDetails.iprogram)) {
          newErrors.intermediateDetails.iprogram =
            "Program should contain text only";
        }
      }
    }
    if (fielname === "" || fielname === "ipercentage") {
      if (!intermediateDetails.ipercentage) {
        ...
        if (
          ...
          newErrors.intermediateDetails.ipercentage =
            "Enter a valid percentage between 0 (only digits and period(.) are allowed)";
        }
      }
    }
    ...
    if (fielname === "" || fielname === "iyearOdPassing") {
      if (!intermediateDetails.iyearOfPassing) {
        newErrors.intermediateDetails.iyearOfPassing =
    ...
    if (fielname === "" || fielname === "iState") {
      if (!intermediateDetails.iState) {
        ...
        if (!/^[a-zA-Z\s]+$/.test(intermediateDetails.iState)) {
          newErrors.intermediateDetails.iState =
            "State should contain text only";
        }
      }
    }
    if (fielname === "" || fielname === "gcollegeName") {
      if (!graduationDetails.gcollegeName) {
        ...
        if (!/^[^\d]+$/.test(graduationDetails.gcollegeName)) {
          newErrors.graduationDetails.gcollegeName =
            "College name should contain text only";
        }
      }
    }
    if (fielname === "" || fielname === "gboard") {
      if (!graduationDetails.gboard) {
        ...
        if (!/^[a-zA-Z\s]+$/.test(graduationDetails.gboard)) {
          newErrors.graduationDetails.gboard =
            "Board name should contain text only";
        }
      }
    }
    if (fielname === "" || fielname === "gprogram") {
      if (!graduationDetails.gprogram) {
        ...
        if (!/^[a-zA-Z\s]+$/.test(graduationDetails.gprogram)) {
          newErrors.graduationDetails.gprogram =
            "Program should contain text only";
        }
      }
    }
    if (fielname === "" || fielname === "gpercentage") {
      if (!graduationDetails.gpercentage) {
        ...
        if (
          ...
          newErrors.graduationDetails.gpercentage =
            "Enter a valid percentage between 0 and 100 (only digits and period(.) are allowed)";
        }
      }
    }
    ...
    if (fielname === "" || fielname === "gyearOfPassing") {
      if (!graduationDetails.gyearOfPassing) {
        newErrors.graduationDetails.gyearOfPassing =
          "Year of passing is required";
      } else {
    ...
    skillsRequired.forEach((skill, index) => {
      if (fielname === "" || fielname === "skillName") {
        if (skill == undefined || !skill.skillName) {
          ...
          if (newErrors.skillsRequired[index] === undefined)
            newErrors.skillsRequired[index] = { skillName: "", experience: "" };
          newErrors.skillsRequired[index].skillName =
            "Skill name should not be a numeric";
        }
      }
      if (fielname === "" || fielname === "experience") {
        if (!skill.experience) {
          ...
          if (newErrors.skillsRequired[index] === undefined)
            newErrors.skillsRequired[index] = { skillName: "", experience: "" };
          newErrors.skillsRequired[index].experience =
            "Experience should be numeric";
        }
      }
    });
    setErrors(newErrors);
    ...
    return Object.keys(newErrors).every(
      (key) => Object.keys(newErrors[key]).length === 0,
    );
  };
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await apiClient.get(
          `/applicantprofile/${user.id}/profile-view`,
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiClient.put(
        `/applicantprofile/updateprofile/${user.id}`,
        formData,
      );
                    ...
                    <div className="profile-setting bg-white">
                      ...
                      <div className="form-infor-profile">
                        ...
                        <div className="form-infor flex flat-form">
                          <div className="info-box info-wd">
                            ...
                            <fieldset>
                              <label class="title-user fw-7">
                                WhatsApp<span className="color-red">*</span>
                              </label>
                              <input
                                type="text"
                            ...
                            <fieldset>
                              ...
                              <select
                                ...
                                style={{
                                  color: qualification ? "black" : "lightgrey",
                                }}
                              >
                            ...
                            <div className="col-lg-6 col-md-12">
                              <div
                                id="item_3"
                                className="dropdown titles-dropdown info-wd"
                              >
                                <label class="title-user fw-7">
                          ...
                          <div className="info-box info-wd">
                            ...
                            <fieldset>
                              ...
                              <select
                                ...
                                style={{
                                  color: specialization ? "black" : "lightgrey",
                                }}
                      ...
                      <div className="form-infor-profile">
                        <h3 className="title-info">
                          Education- Inter/Diploma Details
                          {/* <span className="color-red">*</span> */}
                        </h3>
                        <div className="form-infor flex flat-form">
                          <div className="info-box info-wd">
                          ...
                          <div className="info-box info-wd">
                            <fieldset>
                              <input
                                ...
                                maxLength={4}
                                value={
                                  intermediateDetails?.iyearOfPassing || ""
                                }
                                onChange={(e) =>
                                  setIntermediateDetails({
                                    ...intermediateDetails,
                              ...
                              {experienceDetails &&
                                experienceDetails.map((experience, index) => (
                                  <div key={index}>
                                    ...
                                    >
                                      <label
                                        className="title-user color-1 fw-7"
                                ...
                                <div className="experience-table">
                                  <div>
                                    ...
                                    <input
                                      ...
                                      value=""
                                      onChange={(e) =>
                                        handleSkillChange(e, 0, "skillName")
                                      }
                                      onBlur={() => validateForm("skillName")}
                                    />
                                  ...
                                  <div>
                                    ...
                                    <input
                                      ...
                                      value=""
                                      onChange={(e) =>
                                        handleSkillChange(e, 0, "experience")
                                      }
                      ...
                      <div className="tt-button button-style"></div>
                      <div>
